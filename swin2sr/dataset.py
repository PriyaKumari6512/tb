"""
SR Dataset for DDS3 — used with Swin2SR finetuning.
...
from swin2sr.utils import load_config, read_image, img_to_tensor
...
if __name__ == "__main__":
    ...
    import argparse
    parser = argparse.ArgumentParser(description="Verify Swin2SR dataset loading")
